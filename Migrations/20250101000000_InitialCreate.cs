        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriversLicense = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalLoansValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPaymentsCollected = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalDefaultedLoans = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanAmountRequested = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    LoanAmountApproved = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    InterestRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    MonthlyPayment = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    LoanTermDays = table.Column<int>(type: "int", nullable: false, defaultValue: 30),
                    LoanStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoanMaturityDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoanPaidOffDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    ApprovalNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    TotalInterestCharged = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    RemainingBalance = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TitlePawns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TitlePawns_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TitlePawns_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanBalanceAfterPayment = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_TitlePawns_TitlePawnId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TitlePawns_CompanyId",
                table: "TitlePawns",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TitlePawns_VehicleId",
                table: "TitlePawns",
                column: "VehicleId");
